...
/**
 * @fileoverview Admin Navigation Sidebar Component.
 * Supports desktop relative positioning and mobile slide-out drawer mechanics.
 */
        ...
        <>
            ...
            <div className={`admin-sidebar ${isOpen ? 'open' : ''}`} style={{ 
                ...
                <div style={{ 
                    ...
                    <div>
                        <h2 style={{ margin: 0, color: '#fff', fontSize: '1.8rem', letterSpacing: '2px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <span style={{ color: '#3498db' }}>JGM</span> ADMIN
                        </h2>
                        <p style={{ margin: '5px 0 0 0', color: '#64748b', fontSize: '0.85rem' }}>Management Portal v1.0</p>
                    </div>
                    ...
                    <button 
                        ...
                        onClick={() => setIsOpen(false)} 
                        style={{ background: 'transparent', border: 'none', color: '#94a3b8', fontSize: '1.5rem', cursor: 'pointer', padding: 0 }}
                    >
                        <FaTimes />
                    </button>
                </div>
                ...
                <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    <NavLink to="/" style={navLinkStyle} end><FaChartPie /> Dashboard</NavLink>
                ...
                <div style={{ padding: '20px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                    <button 
                        ...
                        style={{ 
                            ...
                            padding: '12px', backgroundColor: 'rgba(231, 76, 60, 0.1)', color: '#e74c3c',
